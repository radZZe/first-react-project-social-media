...
const Navbar = (props) => {
    debugger;
  let FriendsElements = props.navbarData.friends.map((m) => <FriendsItem name={m.name} pic={m.pic}/>)
  return( 
    <nav className={classes.navbar}>
        <div className={classes.navbar_content}>
            ...
            <div className={`${classes.navbar_settings} ${classes.item}`}><NavLink activeClassName={classes.active} to="/settings">SETTINGS</NavLink></div>
